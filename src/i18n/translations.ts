...
export const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        'modal.encryption_disable_warning': 'Disabling encryption will leave existing files on Yandex Disk encrypted. To reset, delete the remote folder and sync again.',
    ...
    ru: {
        ...
        'modal.encryption_disable_warning': 'Отключение шифрования оставит существующие файлы на Яндекс.Диске зашифрованными. Чтобы сбросить, удалите удалённую папку и выполните синхронизацию заново.',
