...
export const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        'settings.enable_debug_logging_desc': 'Log detailed debug information to console and file',
        'settings.log_to_file': 'Write logs to file',
        'settings.log_to_file_desc': 'Save logs to the plugin data folder for troubleshooting',
        ...
        'notice.encryption_disabled_remotely': 'Encryption was disabled on another device. Switched to plaintext mode.',
        ...
        'notice.encryption_disable_partial': 'Encryption disabled with some errors. Please verify files on disk and locally — some remote API requests failed. If everything looks OK, run a manual sync to ensure full consistency.',
    ...
    ru: {
        ...
        'status.op.getting_remote_files': 'Получение списка удалённых файлов...',
        ...
        'modal.log_viewer_desc': 'Последние записи логов для диагностики проблем',
        ...
        'settings.enable_debug_logging_desc': 'Записывать подробную отладочную информацию в консоль и файл',
        'settings.log_to_file': 'Писать логи в файл',
        'settings.log_to_file_desc': 'Сохранять логи в папку данных плагина для диагностики',
        ...
        'notice.encryption_disabled_remotely': 'Шифрование было отключено на другом устройстве. Переключено в режим без шифрования.',
        ...
        'notice.encryption_disable_partial': 'Шифрование выключено с ошибками. Проверьте файлы на диске и локально — часть удалённых API-запросов завершилась с ошибками. Если всё выглядит корректно, запустите синхронизацию вручную для полной сверки.',
