...
const outputFiles = [
	...
	join(outputDir, "full-delete-causality.test.mjs"),
	join(outputDir, "encrypted-physical-format.test.mjs"),
	join(outputDir, "scenario-catalog.test.mjs"),
...
try {
	await build({
		entryPoints: [
			...
			"tests/full-delete-causality.test.ts",
			"tests/encrypted-physical-format.test.ts",
			"tests/scenario-catalog.test.ts",
